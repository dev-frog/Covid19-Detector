...
export const DEVELOPER_NAME = 'dev-frog';
export const LANDING_CONTENT_TITLE = 'Covid-19 Detector';
export const LANDING_CONTENT_DESCRIBTION = 'A Deep Learning Model Based on the DenseNet50 Architecture';
...
export const CARDCONTENTHEATHER = '';
export const ABOUT_ME_LINK = '';
export const COLAB_LINK = '';
